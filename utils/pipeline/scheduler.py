        ...
        if curr_idx < self.num_warmup_iters:
            ...
            if self.step_by_batch:
                ...
                if curr_idx % self.epoch_length == 0 or curr_idx == self.num_warmup_iters:
                    # After warmup is over, the learning rate adjustment according to epoch has not yet started. At this time, the coefficient needs to be adjusted to the maximum.
