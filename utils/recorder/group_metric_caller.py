...
def ndarray_to_basetype(data):
    """
    Convert a single ndarray, or an ndarray in a tuple, list, or dict to basic data types,
    i.e. lists (.tolist()) and python scalars
    """
...
class ImageMetricRecorder:
    ...
    def __init__(self, metric_names=("sm", "wfm", "mae", "fmeasure", "em")):
        """
        Class used to count various indicators
        """
        if not metric_names:
